...
void GeeetechPrusaI3X::wait()
{
    wait_for("ok");
    wait_for("\n");
}

int GeeetechPrusaI3X::stop()
{
...
int GeeetechPrusaI3X::print(string filename)
{
...
int GeeetechPrusaI3X::information()
{
...
int GeeetechPrusaI3X::custom_gcode(string gcode)
{
